...
{
    public interface IEntity : IIdentifiable<int>, ICreatable<int>, IModifiable<int>, ISoftDeletable<int>, IRowVersionable<uint>, ITranslatable<ExampleEntityTranslation, int, string>, ITenantScopable<int>
    {

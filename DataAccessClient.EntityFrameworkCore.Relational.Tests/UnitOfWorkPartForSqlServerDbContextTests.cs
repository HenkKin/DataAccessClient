...
{
    public class UnitOfWorkPartForRelationalDbContextTests
    {
        private static readonly DbContextOptions Options = new DbContextOptionsBuilder<TestDbContext>()
            .UseInMemoryDatabase(databaseName: "UnitOfWorkPartForRelationalDbContextTests")
        ...
        public async Task SaveAsync_WhenCalled_ItShouldCallSaveChangesAsyncOnDbContext()
        {
            ...
            var testDbContextResolverMock = mockRepository.Create<IRelationalDbContextResolver<TestDbContext>>();
            ...
            var unitOfWorkPart = new UnitOfWorkPartForRelationalDbContext<TestDbContext>(testDbContextResolverMock.Object);
        ...
        {
            // Arrange
            var testDbContextResolverMock = new Mock<IRelationalDbContextResolver<TestDbContext>>();
